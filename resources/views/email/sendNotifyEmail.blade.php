...
<div style="line-height:20px;font-size:1px">&#160;</div>  <a href="https://wasportsrun.com" target="_blank"><img class="center  autowidth " align="center" border="0" src="https://wasportsrun.com/img/wasports-email.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 180px" width="180"></a>
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px;line-height:0px;"><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
  <img class="center  autowidth  fullwidth" align="center" border="0" src="https://wasportsrun.com/storage/uploaded/races/{{$order->header}}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 600px" width="600">
<!--[if mso]></td></tr></table><![endif]-->
	...
	<div style="color:#FFFFFF;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:150%; padding-right: 20px; padding-left: 20px; padding-top: 20px; padding-bottom: 10px;">
		<div style="font-size:12px;line-height:18px;font-family:'Open Sans', Helvetica, Arial, sans-serif;color:#FFFFFF;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: left"><span style="color: rgb(0, 0, 0); font-size: 14px; line-height: 21px;"><strong><span style="font-size: 24px; line-height: 36px;"><span style="line-height: 36px; font-size: 24px;">Congratulations!</span></span></strong></span><span style="font-size: 24px; line-height: 36px; color: rgb(0, 0, 0);"><span style="line-height: 36px; font-size: 24px;"></span></span></p></div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
          ...
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:#FFFFFF;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:#FFFFFF;"><![endif]-->
            ...
            <div class="col num12" style="min-width: 320px;max-width: 600px;display: table-cell;vertical-align: top;">
              ...
              <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                    ...
                    <div class="">
	<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 20px; padding-left: 20px; padding-top: 15px; padding-bottom: 15px;"><![endif]-->
	<div style="color:#FFFFFF;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:150%; padding-right: 20px; padding-left: 20px; padding-top: 15px; padding-bottom: 15px;">
		<div style="font-size:12px;line-height:18px;font-family:'Open Sans', Helvetica, Arial, sans-serif;color:#FFFFFF;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: left"><span style="color: rgb(0, 0, 0); font-size: 14px; line-height: 21px;">Dear {{$order->o_firstname}}, congratulations on completing {{$order->title_en}} successfully. We had shipped your package, hope you love it!</span></p></div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
	...
	<div style="color:#FFFFFF;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:150%; padding-right: 20px; padding-left: 20px; padding-top: 10px; padding-bottom: 10px;">
		<div style="font-size:12px;line-height:18px;font-family:'Open Sans', Helvetica, Arial, sans-serif;color:#FFFFFF;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 18px"><span style="color: rgb(0, 0, 0); font-size: 12px; line-height: 18px;"><?php if($order->courier != null) echo 'Courier: ' .$order->courier; ?></span></p><p style="margin: 0;font-size: 12px;line-height: 18px"><span style="color: rgb(0, 0, 0); font-size: 12px; line-height: 18px;"><?php if($order->tracking_number != null) echo 'Tracking Number: ' .$order->tracking_number; ?></span></p></div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://wasportsrun.com/vieworders" style="height:31pt; v-text-anchor:middle; width:96pt;" arcsize="10%" strokecolor="#e02e3c" fillcolor="#e02e3c"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px;"><![endif]-->
    <a href="https://wasportsrun.com/vieworders" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #e02e3c; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 128px; width: 88px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: 'Open Sans', Helvetica, Arial, sans-serif;mso-border-alt: none">
      <span style="font-family:'Open Sans', Helvetica, Arial, sans-serif;font-size:16px;line-height:32px;"><span style="font-size: 14px; line-height: 36px;"><strong>VIEW ORDER</strong></span></span>
    </a>
