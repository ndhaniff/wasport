...
var b_ib = JSON.parse('[{"preview" : "{{asset("storage/uploaded/bib/".$medal->bib)}}"}]');
var c_ert = JSON.parse('[{"preview" : "{{asset("storage/uploaded/cert/".$medal->cert)}}"}]');
