...
class MyMedalModalEn extends Component{
...
export default MyMedalModalEn

if(document.getElementById('mymedals-en')){
    ReactDOM.render(<MyMedalModalEn />, document.getElementById('mymedals-en'))
}
