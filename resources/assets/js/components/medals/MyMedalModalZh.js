...
class MyMedalModalZh extends Component{
...
export default MyMedalModalZh

if(document.getElementById('mymedals-zh')){
    ReactDOM.render(<MyMedalModalZh />, document.getElementById('mymedals-zh'))
}
