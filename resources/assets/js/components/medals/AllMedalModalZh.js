...
class AllMedalModalZh extends Component{
        ...
        items.push(
          <div className="col-md-4">
            ...
            <Modal
              ...
              footer={false} >
              <RaceMedal medalID={this.state.medalID} medalImg={medal[i]['grey_medal']} />
            </Modal>
...
export default AllMedalModalZh

if(document.getElementById('allmedals-zh')){
    ReactDOM.render(<AllMedalModalZh />, document.getElementById('allmedals-zh'))
}
