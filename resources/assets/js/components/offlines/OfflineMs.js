...
class OfflineMs extends Component{
...
export default OfflineMs

if(document.getElementById('offline-ms')){
    ReactDOM.render(<OfflineMs />, document.getElementById('offline-ms'))
}
