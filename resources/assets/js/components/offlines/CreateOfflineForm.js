...
export default class CreateOfflineForm extends Component {
    ...
    constructor(props){
        ...
        this.state = {
          ...
          raceimg_5 : [],
          raceimg_6 : [],
          toggleDrop_raceimg_1: true,
          toggleDrop_raceimg_2: true,
          toggleDrop_raceimg_3: true,
          toggleDrop_raceimg_4: true,
          toggleDrop_raceimg_5: true,
          toggleDrop_raceimg_6: true,
          show_raceimg_2: false,
          show_raceimg_3: false,
          show_raceimg_4: false,
          show_raceimg_5: false,
          show_raceimg_6: false,
        }
    ...
    handleSubmit(e){
        ...
        let {details_en,details_ms,details_zh,title_en,title_ms,title_zh,category,place,state,date,website,headerImg,raceimg_1,raceimg_2,raceimg_3,raceimg_4,raceimg_5,raceimg_6} = this.state
        ...
        if(message.length != 0) {
          ...
          MySwal.fire({
            ...
            if (result.value) {
              ...
              axios.post('/admin/offlines/create',data).then((res) => {
                  if(res.data.success){
                      MySwal.fire({
                        position: 'top-end',
    ...
    render() {
        ...
        if(this.state.toggleDrop_raceimg_2){
            var dropzone_raceimg_2 =
              <Dropzone
                className="dropzone-style"
                style={{"display": this.state.show_raceimg_2 ? 'block' : 'none'}}
                accept="image/jpeg, image/png"
          ...
          } else { var previewImg_racedimg_3 =  <img src="" alt=""/> }

          if(this.state.toggleDrop_raceimg_3){
              var dropzone_raceimg_3 =
                <Dropzone
                  className="dropzone-style"
                  style={{"display": this.state.show_raceimg_3 ? 'block' : 'none'}}
                  accept="image/jpeg, image/png"
          ...
          if(this.state.toggleDrop_raceimg_4){
              var dropzone_raceimg_4 =
                <Dropzone
                  className="dropzone-style"
                  style={{"display": this.state.show_raceimg_4 ? 'block' : 'none'}}
                  accept="image/jpeg, image/png"
          ...
          if(this.state.toggleDrop_raceimg_5){
              var dropzone_raceimg_5 =
                <Dropzone
                  className="dropzone-style"
                  style={{"display": this.state.show_raceimg_5 ? 'block' : 'none'}}
                  accept="image/jpeg, image/png"
          ...
          if(this.state.toggleDrop_raceimg_6){
              var dropzone_raceimg_6 =
                <Dropzone
                  className="dropzone-style"
                  style={{"display": this.state.show_raceimg_6 ? 'block' : 'none'}}
                  accept="image/jpeg, image/png"
            ...
            <div className="wrapper p-1">
                <div className="row">
                    <div className="col-md-12">
                        <div className="card">
                            <div className="card-header">Create Offline Race</div>
                                    ...
                                    <div className="form-row">
                                      <div className="col-sm-12 col-md-4">
                                        <div className="form-group">
                                          ...
                                          <Datetime onChange={this.handleDate} timeFormat={false}/>
                                      ...
                                      <div className="col-sm-12 col-md-4">
                                        <div className="form-group">
                                          <label>Website</label>
                                          <input onChange={this.handleInputChange} name="website" className="form-control" type="text" />
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div className="form-row">
                                      <div className="col-sm-12 col-md-4">
                                        <div className="form-group">
                                          ...
                                          <input onChange={this.handleInputChange} name="place" className="form-control" type="text" />
                                        </div>
                                      </div>
                                      ...
                                      <div className="col-sm-12 col-md-4">
                                        <div className="form-group">
                                            ...
                                            <select onChange={this.handleStateChange} style={{'display': 'block'}} className="form-select" required>
                                    ...
                                    <div className="form-group">
                                      <Tabs defaultActiveKey="1" type="card">
                                        <TabPane tab="En" key="1">
                                            ...
                                            <ReactQuill style={{'minHeight':'500px'}} modules={this.modules} theme="snow"  value={this.state.details_en} onChange={this.handleDetailsEnChange} />
                                            <input type="hidden" name="medals_en" value={this.state.details_en} required/>
                                        </TabPane>
                                        <TabPane tab="Ms" key="2">
                                            <label htmlFor="details">Details (MS)</label>
                                        ...
                                        <TabPane tab="Zh" key="3">
                                            <label htmlFor="details">Details (ZH)</label>
...
if(document.getElementById('createofflineform')){
    ReactDOM.render(<CreateOfflineForm />, document.getElementById('createofflineform'))
}
