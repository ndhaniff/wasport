              ...
              <div className="col-md-12 control-label">
                <div className="col-md-12 txt">
                  <div className="col-md-4">
                    Gender: {this.props.getStore().gender}
                  </div>
                  <div className="col-md-4">
                ...
                <div className="col-md-12 txt">
                  <div className="col-md-4">
                    Emergency Email: {this.props.getStore().emailEmergency}
                  </div>
                  <div className="col-md-4">
                    First Name : {this.props.getStore().firstname}
                  </div>
                </div>
                <div className="col-md-12 txt">
                  <div className="col-md-4">
                    Last Name : {this.props.getStore().lastname}
                  </div>
                  <div className="col-md-4">
