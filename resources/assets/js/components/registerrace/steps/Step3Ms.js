...
class Step3Ms extends Component {
  constructor(props) {
    super(props);
      ...
      for(var i=0; i<addons.length; i++) {
        ...
        {getFieldDecorator('addon_' + j, {
          ...
          <RadioGroup onChange={this.handleRadioChange}>
            <RadioButton value={addons[i]['aid'] + ',none'}>Tiada</RadioButton>
      ...
      return(
        <Form onSubmit={this.handleSubmit}>
          ...
          {getFieldDecorator('race_category', {
            rules: [{ required: true, message: 'Sila memilih kategori acara!' }],
        ...
        <FormItem {...formItemLayoutWithOutLabel}>
          <Button type="primary" onClick={() => this.jumpToStep(1)} id="register-race-prev">Balik</Button>
...
const Step3FormMs = Form.create()(Step3Ms);

export default Step3FormMs
