...
class Step3Zh extends Component {
  constructor(props) {
    super(props);
      ...
      var engrave_input =
        ...
        >
          {getFieldDecorator('engrave_name', {
            rules: [
              { required: true, message: '请填入奖牌所需刻的字!', whitespace: true },
              { min: 1, message: '奖牌刻字需至少 1 个字母' },
              { max: 15, message: '奖牌刻字需少过 15 个字母' },
            ],
    ...
    if(typeof addons[0] != 'undefined') {
      ...
      for(var i=0; i<addons.length; i++) {
        ...
        {getFieldDecorator('addon_' + j, {
          rules: [{required: true, message: '请选择添加物件!' }],
        })(
          <RadioGroup onChange={this.handleRadioChange}>
            <RadioButton value={addons[i]['aid'] + ',none'}>无</RadioButton>
      ...
      return(
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem
            ...
            hasFeedback
          >
            {getFieldDecorator('title_zh', {
              rules: [{
                required: true, message: '请填入参加赛事',
              }],
              initialValue : this.state.title_zh
            })(
        ...
        <FormItem {...formItemLayoutWithOutLabel}>
          <Button type="primary" onClick={() => this.jumpToStep(1)} id="register-race-prev">上一步</Button>
...
const Step3FormZh = Form.create()(Step3Zh);

export default Step3FormZh
