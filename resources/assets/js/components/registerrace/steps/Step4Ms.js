...
class Step4Ms extends Component {
  constructor(props) {
    super(props);
        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <div className="row">
            <div className="col-sm-9">
              <b>{this.state.title_ms}</b><br />
              Kategori: {this.state.race_category} <br />
              {displayEngrave}
            </div>
          ...
          <span>
            Dengan mendaftar, Anda setuju dengan <a href="/termsandconditions" target="_blank">syarat & ketentuan</a> kami.
          </span>
...
const Step4FormMs = Form.create()(Step4Ms);

export default Step4FormMs
